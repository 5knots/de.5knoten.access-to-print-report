...
<!-- Extension access-to-print-report: changed from $hasAccessToAllCases to $hasAccessToMyCases -->
        {if $hasAccessToMyCases}
      ...
      <table id="caseRoles-selector-{$caseID}"  class="report-layout crm-ajax-table" data-page-length="10">
        <thead>
          <tr>
            ...
            {if $relId neq 'client' and $hasAccessToMyCases}
